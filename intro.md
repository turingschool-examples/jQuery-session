...
- our code will malfunction for users if it isn't a normal dependency. devDependency's are for code that isn't required to run the code, but jQuery IS required to run our code.
