...
Make sure the script tag is above your main js script tag and the jQuery file is in your js directory

3. Why would we bring in jQuery as a `dependency` rather than a `devDependency`?

Both the developer and the user will need to have jQuery access for the application to
work properly
